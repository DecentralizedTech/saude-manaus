export type TipoUnidade = 'HOSPITAL' | 'UPA' | 'SPA' | 'UFS' | 'POLICLINICA'
...
export const TIPO_UNIDADE_LABEL: Record<TipoUnidade, string> = { HOSPITAL: 'Hospital', UPA: 'UPA', SPA: 'SPA', UFS: 'UFS', POLICLINICA: 'Policlínica' }
...
export const TIPO_UNIDADE_COLOR: Record<TipoUnidade, string> = {
  HOSPITAL: 'bg-red-100 text-red-700', UPA: 'bg-orange-100 text-orange-700', SPA: 'bg-blue-100 text-blue-700', UFS: 'bg-green-100 text-green-700', POLICLINICA: 'bg-purple-100 text-purple-700',
}
